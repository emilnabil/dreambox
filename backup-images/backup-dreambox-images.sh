#!/bin/bash
## setup command=wget https://github.com/emilnabil/dreambox/raw/refs/heads/main/backup-images/backup-dreambox-images.sh -O - | /bin/sh
##################################
...
"https://github.com/emilnabil/dreambox/raw/refs/heads/main/bootlogoswaper-dreambox.sh"
