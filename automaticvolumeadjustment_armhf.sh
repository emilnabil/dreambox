#!/bin/bash
#
## command=wget https://github.com/emilnabil/dreambox/raw/refs/heads/main/automaticvolumeadjustment_armhf.sh -O - | /bin/sh
#####################
...
curl -kL "https://github.com/emilnabil/dreambox/raw/refs/heads/main/automaticvolumeadjustment_armhf.tar.gz" -o /tmp/automaticvolumeadjustment_armhf.tar.gz
if [ $? -ne 0 ]; then
...
tar -xzf /tmp/automaticvolumeadjustment_armhf.tar.gz -C /
if [ $? -ne 0 ]; then
...
echo "Cleaning up..."
rm -f /tmp/automaticvolumeadjustment_armhf.tar.gz
